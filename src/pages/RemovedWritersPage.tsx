...
export const RemovedWritersPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const updateRemovedWritersList = () => {
      const removedWritersList: RemovedWriter[] = [];

      Object.values(usersData).forEach((writer: any) => {
    ...
    unsubscribes.push(usersUnsubscribe, articlesUnsubscribe);
